...
当前稳定版本为 `v1.8.6`。版本变更见 [`CHANGELOG.md`](CHANGELOG.md)，开发、提交和 Tag 发布规则见 [`CONTRIBUTING.md`](CONTRIBUTING.md)。
...
- 教师后台可维护外部学习网站，并上传单 HTML、完整项目文件夹或 ZIP 教学网页
- 教学网页支持预览、改名、替换版本、排序和删除，原始压缩源随 SQLite 一起备份
...
- 已登录手机可扫描电脑端一次性二维码，确认后让电脑以同一教师账号登录
- 手机教师后台提供“扫一扫”按钮，可调用原生相机识别电脑端登录二维码
